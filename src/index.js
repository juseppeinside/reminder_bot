        ...
        messages: [
          {
            ...
            content: `Ты АИ ассистент для приложения для напоминаний, от которого в ответ я должен получать только ответ в формате 
                      ...
                      2. Определи время напоминания:
                        - Если в тексте ЯВНО указан интервал (например, "напомни за 30 минут", "за час до начала", "напомни за 15 минут"), ТОЛЬКО ТОГДА вычти этот интервал из времени события.
                        - Если интервал НЕ указан явно, используй ТОЧНОЕ время самого события как время напоминания БЕЗ вычитания каких-либо интервалов.
                      ...
                      Пример 2:
                      Вход: «Завтра запись к проктологу в 12:00»
                      Выход: /message [Запись к проктологу] [12:00]

                      Пример 3:
                      Вход: «Завтра поход к врачу в 14»
                      Выход: /message [Поход к врачу] [14:00]`,
          },
          {
            role: "user",
